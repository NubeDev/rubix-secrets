//! Rubix secret-storage trait.
//!
//! Three classes of secret material exist on a Rubix install:
//!
//! 1. **Long-lived bearers** — OIDC refresh tokens, fleet bootstrap secrets,
//!    rubixd `owner_token`. Loss = account takeover. These belong in a
//!    [`SecretStore`].
...
//!
//! See `rubix-agent/docs/design/desktop/SECRETS.md` for the full design rationale,
